...
Les ecarts entre les points du maillage (positions au repos) sont tous les mêmes --> dimensions théoriques
les k sont des fausses raideurs inventées sur la base de H.P. Jacques (2008)
"""
...
if affichage == 'subplot' :
    ...
    for time in range(1, Nb_increments):
        ...
        for index in range (n*m) :
            accel[time, index, :] = (F_point[index,:] + Force_amortissement[time-1,index,:])  / M[index]
